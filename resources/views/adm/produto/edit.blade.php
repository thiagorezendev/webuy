@section('titulo', 'Novo Produto')
  ...
  @section('content')
    <form action="{{ route('adm.produto.update', $produto->id_produto) }}" method="POST">
        @csrf
        <h1 class="h1 my-4 text-center">Novo Produto</h1>
        <div class="row g-2">
            <div class="col-md-7 col-sm-12">
                <input type="text" class="form-control mb-2" name="nome_produto" value="{{ $produto->nome_produto }}" placeholder="Nome">
            ...
            <div class="col-md col-sm-12">
                ...
                <div class="input-group mb-2">
                    ...
                    <input type="number" class="form-control" name="preco_produto" value="{{ $produto->preco_produto }}" placeholder="Preço">
                </div>
        ...
        <div class="input-group mb-2">
            ...
            <textarea class="form-control form-control-lg" aria-label="With textarea" name="desc_produto" value="{{ $produto->desc_produto }}"></textarea>
        </div>
