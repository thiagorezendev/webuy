...
@section('content')
    <form action="{{ route('adm.compra.update', $compra->id_compra) }}" method="POST">
        ...
        <div class="row g-2">
            <div class="col-md col-sm-12">
                <input type="number" class="form-control" name="qntd_compra" value="{{ $compra->qntd_compra }}"
            ...
            <div class="input-group col-md col-sm-12">
                ...
                <input type="number" class="form-control" name="preco_uni_compra" value="{{ $compra->preco_uni_compra }}"
