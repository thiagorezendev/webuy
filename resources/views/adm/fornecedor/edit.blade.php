    ...
    <form action="{{ route('adm.fornecedor.update', $fornecedor->id_fornecedor) }}" method="POST">
        ...
        <div class="row g-2">
            <div class="col-md col-sm-12">
                <input type="text" class="form-control" name="nome_fornecedor" value="{{ $fornecedor->nome_fornecedor }}" placeholder="Nome">
            </div>
            <div class="col-md col-sm-12">
                <div class="input-group mb-2">
                    <span class="input-group-text">@</span>
                    <input type="text" class="form-control" name="email_fornecedor" value="{{ $fornecedor->email_fornecedor }}" placeholder="Email">
                </div>
            </div>
        </div>
        <div class="row g-2">
